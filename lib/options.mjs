...
/** Detached JSON snapshot of every configurable option. */
export function snapshot() {
  return {
    dbhubPackage: options.dbhubPackage,
...
// Per-field validators: only valid JSON-shaped values can change an option
// (the settings schema normally gates the front door; this is the backstop).
const VALIDATORS = {
  dbhubPackage: (v) => typeof v === 'string' && v.trim() !== '',
